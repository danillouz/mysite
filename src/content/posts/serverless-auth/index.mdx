...
>
> <cite>
>   [AWS docs: Use API Gateway Lambda
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/serverless-auth/auth0/api-permissions.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/serverless-auth/auth0/test-application.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/serverless-auth/auth0/grant-scope-1.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/serverless-auth/auth0/grant-scope-2.png"
    )}
