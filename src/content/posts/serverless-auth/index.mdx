...
<figure>
  <Image
    src={import("../../../assets/posts/serverless-auth/auth0/register.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/serverless-auth/auth0/quick-start.png")}
...
<cite>
<p>[AWS docs: Use API Gateway Lambda authorizers](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-use-lambda-authorizer.html)</p>
</cite>
</blockquote>
...
<figure>
  <Image
    src={
      import("../../../assets/posts/serverless-auth/auth0/api-permissions.png")
    }
...
<figure>
  <Image
    src={import("../../../assets/posts/serverless-auth/auth-flow.png")}
...
<figure>
  <Image
    src={
      import("../../../assets/posts/serverless-auth/auth0/test-application.png")
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/serverless-auth/auth0/grant-scope-1.png")
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/serverless-auth/auth0/grant-scope-2.png")
    }
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/serverless-auth/aws/lambda-authorizer-arn.png"
      )
    }
...
<figure>
  <Image
    src={import("../../../assets/posts/serverless-auth/auth0/test.png")}
