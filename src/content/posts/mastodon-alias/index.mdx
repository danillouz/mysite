...
tags: ["astro", "mastodon", "vercel", "webfinger"]
...
<cite>
<p>[RFC 7033: Introduction](https://www.rfc-editor.org/rfc/rfc7033#section-1)</p>
</cite>
</blockquote>
...
<figure>
  <Image
    src={import("../../../assets/posts/mastodon-alias/mastodon-search.png")}
...
<cite>
<p>[Mastodon docs: Your username and your domain](https://docs.joinmastodon.org/user/signup/#address)</p>
</cite>
</blockquote>
...
<cite>
<p>[Mastodon docs: Perform a search](https://docs.joinmastodon.org/methods/search/#query-parameters)</p>
</cite>
</blockquote>
