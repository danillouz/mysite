...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/audio-transcoding-lambda/create-pipeline.png"
      )
    }
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/audio-transcoding-lambda/created-pipeline.png"
      )
    }
...
<figure>
  <Image
    src={import("../../../assets/posts/audio-transcoding-lambda/preset.png")}
...
<figure>
  <Image
    src={
      import("../../../assets/posts/audio-transcoding-lambda/created-job.png")
    }
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/audio-transcoding-lambda/published-layer.png"
      )
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/audio-transcoding-lambda/logs-timeout.png")
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/audio-transcoding-lambda/logs-complete.png")
    }
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/audio-transcoding-lambda/logs-double-memory.png"
      )
    }
