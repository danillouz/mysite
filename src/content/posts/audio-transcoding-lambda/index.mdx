...
<figure>
  <Image
    src={import(
      "../../../assets/posts/audio-transcoding-lambda/created-job.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/audio-transcoding-lambda/logs-timeout.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/audio-transcoding-lambda/logs-complete.png"
    )}
