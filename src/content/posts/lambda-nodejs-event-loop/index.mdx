...
<figure>
  <Image
    src={import(
      "../../../assets/posts/lambda-nodejs-event-loop/call-stack.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/lambda-nodejs-event-loop/call-stack/1.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/lambda-nodejs-event-loop/call-stack/2.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/lambda-nodejs-event-loop/call-stack/3.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/lambda-nodejs-event-loop/call-stack/4.png"
    )}
...
<figure>
  <Image
    src={import(
      "../../../assets/posts/lambda-nodejs-event-loop/event-loop.png"
    )}
