...
<figure>
  <Image
    src={
      import("../../../assets/posts/lambda-nodejs-event-loop/call-stack.png")
    }
    alt="Call stack with 2 frames."
  />
...
<figure>
  <Image
    src={
      import("../../../assets/posts/lambda-nodejs-event-loop/call-stack/1.png")
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/lambda-nodejs-event-loop/call-stack/2.png")
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/lambda-nodejs-event-loop/call-stack/3.png")
    }
...
<figure>
  <Image
    src={
      import("../../../assets/posts/lambda-nodejs-event-loop/call-stack/4.png")
    }
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/queue.png")}
...
<figure>
  <Image
    src={
      import("../../../assets/posts/lambda-nodejs-event-loop/event-loop.png")
    }
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/console/1.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/console/2.png")}
...
<cite>
<p>[AWS docs: Lambda execution environment](https://docs.aws.amazon.com/lambda/latest/dg/running-lambda-code.html)</p>
</cite>
</blockquote>
...
<cite>
<p>[AWS docs: Lambda function handler in Node.js](https://docs.aws.amazon.com/lambda/latest/dg/nodejs-prog-model-handler.html)</p>
</cite>
</blockquote>
...
<blockquote>
<p>The default value is `true`. This property is useful only to modify the default behavior of the callback. **By default, the callback will wait until the event loop is empty before freezing the process and returning the results to the caller**.</p>

<cite>
<p>[AWS docs: Lambda context object in Node.js](https://docs.aws.amazon.com/lambda/latest/dg/nodejs-prog-model-context.html)</p>
</cite>
</blockquote>
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/1.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/2.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/3.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/4.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/5.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/6.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/7.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/8.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/9.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/10.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/11.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/12.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/13.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/14.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/15.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/16.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/17.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/18.png")}
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/lambda/19.png")}
    alt="Event loop visualized when executing step 18 of the timeout js script."
  />
</figure>
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/lambda-nodejs-event-loop/lambda/exec-context-1.png"
      )
    }
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/lambda-nodejs-event-loop/lambda/exec-context-2.png"
      )
    }
...
<figure>
  <Image
    src={
      import(
        "../../../assets/posts/lambda-nodejs-event-loop/lambda/exec-context-3.png"
      )
    }
...
<figure>
  <Image
    src={import("../../../assets/posts/lambda-nodejs-event-loop/console/3.png")}
